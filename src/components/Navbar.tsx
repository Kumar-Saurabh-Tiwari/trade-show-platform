        ...
        <div className="flex justify-between items-center h-20">
            ...
            {navItems.map((item, index) => (
              <motion.a
                ...
                className={`font-bold transition-all duration-300 hover:scale-105 relative group ${
                  isScrolled ? 'text-gray-700 hover:text-blue-600' : 'text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)] hover:text-blue-100'
                }`}
              >
                {item.label}
          ...
          <div className="hidden md:flex items-center gap-4">
            <motion.button
              ...
              className={`px-6 py-2 rounded-lg font-bold transition-all duration-300 ${
                isScrolled
                  ...
                  : 'text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)] hover:text-blue-100 hover:bg-white/10'
              }`}
            >
              Sign In
            </motion.button>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-bold shadow-lg hover:shadow-xl transition-all drop-shadow-[0_2px_6px_rgba(0,0,0,0.3)]"
            >
              Get Started
            </motion.button>
          </div>
